...
const WRT_config = {
  ...
  title_A050: "新系统",
  title_1111: "数据汇聚更新",
  // server: "http://192.168.199.167:9003",
  server: "http://172.20.89.88:5001",
  serverCompatible: "http://172.20.89.88:5001",
  // server: "http://172.20.89.68:5001",
  // serverCompatible: "http://172.20.89.68:5001",
  ...
  appname: "JdwEdit",
  res: 'testsjk',
  // qyzgSever: "http://lysb.lucheng.gov.cn",
  // qyzgSever: "http://172.20.89.68:5001",
  ...
  // loginSever: 'http://172.20.89.68:5001',
  // lcSever: 'http://172.20.89.68:5001',
  // lcManagerSever: "http://172.20.89.68:5001",
  // 以下为动态数据：
  user_type: '', // 登录类型，默认 ""
  au_userid: 0, // 用户  ID
  au_username: '', // 用户名
